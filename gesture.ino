//----------------------------------------------------------------
//-- Otto DIY Android APP 122 code
//-- (c) (http://ottodiy.com) Released under a GPL licencse
//-- 03 March 2018
//-- Author: Jason Snow
//-----------------------------------------------------------------
//-- FEBRUARY 2017: modified for OttoDIY with MAX7219 MATRIX LED module
//-- allows OttoDIY to work with Zowi APP
//-- Jason Snow
//-- JANUARY 2018: modified for new OttoDIY App
//-- Jason Snow
//--JANUARY 2019: modified for work with TGB LEDs WS2813
//-----------------------------------------------------------------
...
void requestRGB(){  
    ...
    //L 000000001000010100100011000000000
    //L 001111111111111111111111111111111 (todos los LED encendidos)
//    unsigned long int colour=0x999999;
    char *arg;
    char *endstr;
    arg=SCmd.next();
    Serial.println (arg);
    if (arg != NULL) {
      unsigned long int colour=strtoul(arg,&endstr,16);
      Otto.changecolour(colour);    // Converts a char string to unsigned long integer
