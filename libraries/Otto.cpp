...
unsigned long int Otto::getAnimShape(int anim, int index){
  ...
  unsigned long int littleUuh_code[]={
     ...
     0b0010001010010100010000000,
     0b0000001100011000000000000,
     0b0000001100011000000000000,
     0b0010001010010100010000000,
     0b0010001010010100010000000,
     0b0010001010010100010000000,
  ...
  unsigned long int wave_code[]={
     ...
     0b0001000010001100001000010,
     0b0001000110011100011000010,
     0b0001000010001100001000010,
     0b0001000010000100001000010,
     0b0001001110111100111000010,
     0b0001000110011100011000010,
     0b0001000010001100001000010,
     0b0001000010000100001000010,
     0b0001000010000100001000010    
...
void Otto::changecolour(unsigned long int colour){
  ledmatrix.colour=colour;
}
